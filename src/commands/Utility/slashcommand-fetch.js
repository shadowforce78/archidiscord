const { ChatInputCommandInteraction, PermissionsBitField, ChannelType, AttachmentBuilder } = require("discord.js");
const DiscordBot = require("../../client/DiscordBot");
const ApplicationCommand = require("../../structure/ApplicationCommand");
const { bigIntToPermissionNames } = require("../../referentiel/helpers");
const { ChannelTypes } = require("../../referentiel/channelTypes");
...
// ═══════════════════════════════════════════════════════════════════
//  CONSTRUCTION DU BLUEPRINT DEPUIS LE SERVEUR
// ═══════════════════════════════════════════════════════════════════
